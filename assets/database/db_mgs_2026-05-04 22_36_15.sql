...
-- Copiando dados para a tabela db_mgs.tb_img_vaga: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela db_mgs.tb_suporte: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela db_mgs.tb_users: ~1 rows (aproximadamente)
INSERT INTO `tb_users` (`id`, `nome`, `cargo`, `email`, `telefone`, `biografia`, `endereco`, `foto_perfil`, `foto_banner`, `data_cadastro`, `ativo`) VALUES
	(4, 'Pedro.Azevedo', 'Técnico em T.I', 'pedro1234@hotmail.com', '19999999999', ' Profissional de Tecnologia da Informação com conhecimento em desenvolvimento web, suporte técnico e design gráfico.\r\n', '13870-000 • São João da Boa Vista - SP', 'assets/img/perfil-candidato/uploads/69f92797dec83_3984ef9d7ae353bda9fe06297daf458d.png', 'assets/img/perfil-candidato/uploads/69f92797dfc3b_01ddfbcf3f16d1cd4d78f1d977fbfd15.png', '2026-04-30 00:50:47', 1);
...
-- Copiando dados para a tabela db_mgs.tb_vagas: ~4 rows (aproximadamente)
INSERT INTO `tb_vagas` (`id`, `vaga`, `area_atuacao`, `modalidade`, `localizacao`, `descricao`, `requisitos`, `salario`, `beneficio`, `carga_horaria`, `data_cadastro`, `ativo`, `modelo_de_trabalho`) VALUES
	(7, 'teste', 'teste', 'Presencial', 'teste', 'teste', 'teste', 0.00, 'teste', 'teste', '2026-05-04 21:29:14', 1, 'Presencial'),
	(8, 'testeee', 'testeee', 'Presencial', 'testeee', 'testeee', 'testeee', 0.00, 'testeee', 'testeee', '2026-05-04 21:34:16', 1, 'Home Office'),
	(9, 'testeee', 'testeee', 'Presencial', 'testeee', 'testeee', 'testeee', 0.00, 'testeee', 'testeee', '2026-05-04 21:36:06', 1, 'Presencial'),
	(10, 'Teste', 'testeee', 'Híbrido', 'testeee', 'testeee', 'testeee', 0.00, 'testeee', 'testeee', '2026-05-04 21:37:56', 1, 'Home Office');
