...
-- Copiando dados para a tabela db_mgs.tb_suporte: ~4 rows (aproximadamente)
INSERT INTO `tb_suporte` (`id`, `nome`, `email`, `data_cadastro`, `ativo`, `descricao`) VALUES
	(3, 'João Buffo', 'SJB.Solucoes@gmail.com', '2026-04-06 21:23:21', 1, 'Não estou conseguindo registrar meus serviços para meus clientes.'),
	(4, 'Pedro', 'Pedro@gmail.com', '2026-04-06 21:40:15', 1, 'Não estou conseguindo postrar vaga de contratação para minhha estética automotíva'),
	(5, 'Kaua Lanzieri', 'Kaua@gmail.com', '2026-04-06 21:42:12', 1, 'Estou contratando para minha oficina de hardware'),
	(6, 'Icaro Santos', 'Icaro@gmail.com', '2026-04-06 21:53:15', 1, 'Não estou conseguindo contratar para minhfa oficina de motos');
